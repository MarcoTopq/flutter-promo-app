...
class _AllVideosState extends State<AllVideos> {
  ...
  Future<void> _refreshData(BuildContext context) async {
    await Provider.of<VideosModel>(context, listen: false).fetchDataVideos();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
            ...
            child: FutureBuilder(
                future: Provider.of<VideosModel>(context, listen: false)
                    .fetchDataVideos(),
                builder: (ctx, snapshop) {
                  if (snapshop.connectionState == ConnectionState.waiting) {
                    ...
                    return Consumer<VideosModel>(
                        builder: (ctx, _listVideos, child) => Center(
                              ...
                              SliverList(
                                delegate: SliverChildBuilderDelegate(
                                  ...
                                  childCount: _listVideos.listVideos.length,
                                ),
                              ),
                            ])));
                  }
