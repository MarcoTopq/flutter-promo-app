...
List<AllEventDetail> allEventDetailFromJson(String str) =>
    List<AllEventDetail>.from(
        json.decode(str).map((x) => AllEventDetail.fromJson(x)));

String allEventDetailToJson(List<AllEventDetail> data) =>
...
class EventModel with ChangeNotifier {
  ...
  Future<void> fetchDataEvent() async {
    final response = await http.get(Uri.encodeFull(urls + '/api/event'),
