...
List<AllNewsDetail> allNewsDetailFromJson(String str) =>
    List<AllNewsDetail>.from(
        json.decode(str).map((x) => AllNewsDetail.fromJson(x)));

String allNewsDetailToJson(List<AllNewsDetail> data) =>
...
class NewsModel with ChangeNotifier {
  ...
  Future<void> fetchDataNews() async {
    final response = await http.get(Uri.encodeFull(urls + '/api/news'),
